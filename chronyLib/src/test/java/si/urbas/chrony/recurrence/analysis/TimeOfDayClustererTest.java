...
public class TimeOfDayClustererTest {
  ...
  public void millisOfDayClusters_MUST_return_an_empty_list_WHEN_there_are_no_samples() {
    int[] millisOfDayClusters = millisOfDayClusters(EventSamplesTestUtils.emptyEventSamples());
  ...
  public void millisOfDayClusters_MUST_return_a_single_time_WHEN_all_event_samples_occur_at_the_exact_same_time_of_day() {
    assertArrayEquals(
      ...
      millisOfDayClusters(someEventSamplesAt(millisOfDay(16, 0)))
    );
  }
  ...
  public void millisOfDayClusters_MUST_return_an_average_time() {
    ...
    assertArrayEquals(
      ...
      millisOfDayClusters(eventSamples)
    );
  }
  ...
  public void millisOfDayClusters_MUST_find_two_clusters() {
    ...
    assertArrayEquals(
      ...
      millisOfDayClusters(Iterables.merge(eventSamples16_00, eventSamples17_00, EventSampleOldestFirstComparator.INSTANCE))
    );
  }
