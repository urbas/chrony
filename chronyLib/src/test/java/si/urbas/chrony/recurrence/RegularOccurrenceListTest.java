...
public class RegularOccurrenceListTest {
  ...
  public void size_MUST_return_0_WHEN_toTime_is_smaller_than_first_occurrence_time() {
    RegularOccurrenceList occurrences = new RegularOccurrenceList(123, 42, 150);
