...
public class UnidirectionalUpgraderTest {
  ...
  private UnidirectionalUpgrader<String> unidirectionalUpgrader;
  ...
  public void setUp() throws Exception {
    ...
    unidirectionalUpgrader = new UnidirectionalUpgrader<String>()
      .add(version1)
      .add(version2)
      .add(version3);
  }
  ...
  public void upgrade_MUST_call_the_upgrade_script_for_the_first_version() {
    unidirectionalUpgrader.upgrade(UPGRADE_DATA, VERSION_0, VERSION_1);
    verify(version1).upgrade(UPGRADE_DATA);
  }

  @Test
  public void upgrade_MUST_call_the_upgrade_script_for_the_second_version() {
    unidirectionalUpgrader.upgrade(UPGRADE_DATA, VERSION_1, VERSION_2);
  ...
  public void upgrade_MUST_throw_an_exception_WHEN_an_upgrade_script_for_the_given_version_does_not_exist() {
    unidirectionalUpgrader.upgrade(UPGRADE_DATA, VERSION_1, VERSION_4);
  }
  ...
  public void upgrade_MUST_throw_an_exception_WHEN_the_current_version_is_larger_than_the_new_version() {
    unidirectionalUpgrader.upgrade(UPGRADE_DATA, VERSION_2, VERSION_1);
  }

  @Test
  public void upgrade_MUST_not_invoke_any_scripts_WHEN_the_current_version_the_same_as_the_new_version() {
    unidirectionalUpgrader.upgrade(UPGRADE_DATA, VERSION_2, VERSION_2);
    verifyZeroInteractions(version1);
